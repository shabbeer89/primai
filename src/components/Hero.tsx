        ...
        <div className="flex flex-col justify-center md:hidden">
          ...
          <div className="text-center mb-8">
            ...
            <div className={`flex flex-col gap-3 md:flex-row md:gap-4 opacity-0 transition-all duration-600 delay-600 ${heroVisible ? 'opacity-100 translate-y-0' : 'translate-y-4'}`}>
              ...
              <button
                onClick={handleGetStarted}
                className="bg-purple-500 text-white border-2 border-gray-200 px-6 py-4 md:px-8 md:py-4 rounded-xl font-semibold hover:border-indigo-600 hover:text-indigo-600 hover:-translate-y-1 transition-all flex items-center justify-center gap-2 min-h-[44px] text-base">
                Get A Demo
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
        ...
        <div className="hidden md:grid md:grid-cols-2 md:gap-20 md:items-center">
          ...
          <div>
            ...
            <div className={`flex gap-4 opacity-0 transition-all duration-600 delay-600 ${heroVisible ? 'opacity-100 translate-y-0' : 'translate-y-4'}`}>
              <button
                onClick={handleGetStarted}
                className="bg-indigo-600 text-white px-8 py-4 rounded-xl font-semibold hover:bg-indigo-700 hover:-translate-y-1 hover:cursor-pointer transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 min-h-[44px]"
              >
                Get Started
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              ...
              <button
                onClick={handleGetStarted}
                className="bg-purple-500 text-white border-2 border-gray-200 px-8 py-4 rounded-xl font-semibold hover:border-indigo-600 hover:text-indigo-600 hover:-translate-y-1 hover:cursor-pointer transition-all flex items-center justify-center gap-2 min-h-[44px]"
              >
                Get A Demo
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                  <path d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" fill="currentColor" />
